...
(() => {
  ...
  // a rate built on a yield-bearing denomination: give both halves
  const compo = o => (o && o.apy_intrinsic != null) ? `${pct(o.apy_intrinsic)} ${esc(o.apy_denom || '')} staking + ${pct(o.apy_vault_own || 0)} venue` : '';
